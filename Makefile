# ============================================================
# Makefile – OS Project (Milestones 1, 2, 3, 4, 5)
# ============================================================
...
M5_SRC       = milestone5.c milestone4.c child.c child_ipc.c parent_ipc.c \
               gui.c graph.c Dijkstra.c
...
# Milestone 4 – multiple travelers, parent computes paths (./sim <file>)
milestone4: $(M4_SRC) milestone4.h gui.h graph.h child.h
	$(CC) $(CFLAGS) -o sim $(M4_SRC) $(LIBS) $(RAYLIB_FLAGS)
	@echo "Built: sim (milestone 4)"

# Milestone 5 – autonomous children with IPC (./sim <file>)
milestone5: $(M5_SRC) milestone4.h gui.h graph.h child.h child_ipc.h parent_ipc.h ipc_protocol.h
	$(CC) $(CFLAGS) -o sim $(M5_SRC) $(LIBS) $(RAYLIB_FLAGS)
	@echo "Built: sim (milestone 5)"
